...
export default function Header() {
  ...
  <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-10 h-[68px] flex items-center justify-center sm:justify-between relative">
    ...
    >
      ...
      {/* Logo */}
      <div className="relative h-[72px] w-[180px] flex items-center justify-center overflow-hidden">
        <img
          src={logo}
          alt="Manovaidya"
    ...
    <a
      ...
      className="hidden sm:inline-flex items-center justify-center bg-[#5f46b2] hover:bg-[#533ba5] text-white px-5 sm:px-7 h-[40px] rounded-full text-[14px] sm:text-[15px] font-semibold transition-all duration-300 shadow-[0_8px_24px_rgba(95,70,178,0.25)]"
    >
      Book ₹499 Assessment
    </a>
  </div>
